...
import YazzyYazWordleYazzyyazWordleWordle from './YazzyYaz/wordle/yazzyyaz.wordle.wordle'
...
export default { 
  YazzyYazWordleYazzyyazWordleWordle: load(YazzyYazWordleYazzyyazWordleWordle, 'yazzyyaz.wordle.wordle'),
